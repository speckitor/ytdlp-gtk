...
static void activate(GApplication *app)
{
    ...
    video_resolution_drop_down =
        GTK_DROP_DOWN(gtk_builder_get_object(build, "video_resolution_drop_down"));
    video_format_drop_down = GTK_DROP_DOWN(gtk_builder_get_object(build, "video_format_drop_down"));
    audio_quality_drop_down =
        GTK_DROP_DOWN(gtk_builder_get_object(build, "audio_quality_drop_down"));
